...
%cogColors = (    #Oranges
    A       => "rgb(255,0,0)",        #red
    B       => "rgb(255,99,71)",      #tomato
    J       => "rgb(240,128,128)",    #light coral
    K       => "rgb(255,140,0)",      #dark orange
    L       => "rgb(255,20,147)",     #deep pink
                                      #Greens/Yellows
    D       => "rgb(240,230,140)",    #khaki
    O       => "rgb(189,183,107)",    #dark khaki
    M       => "rgb(107,142,35)",     #olive drab
    N       => "rgb(34,139,34)",      #forest green
    P       => "rgb(154,205,50)",     #yellow green
    T       => "rgb(50,205,50)",      #lime green
    U       => "rgb(173,255,47)",     # green yellow
    V       => "rgb(0,250,154)",      #medium spring green
    W       => "rgb(143,188,143)",    #dark sea green
    Y       => "rgb(60,179,113)",     #medium sea green
    Z       => "rgb(255,255,0)",      #yellow
                                      #Blues/Purples
    C       => "rgb(0,255,255)",      #cyan
    G       => "rgb(0,206,209)",      #dark turquoise
    E       => "rgb(70,130,180)",     #steel blue
    F       => "rgb(0,191,255)",      #deep sky blue
    H       => "rgb(0,0,255)",        #blue
    I       => "rgb(106,90,205)",     #slate blue
    Q       => "rgb(0,0,128)",        #navy
                                      #Grays
    R       => "rgb(190,190,190)",    #gray
    S       => "rgb(105,105,105)",    #dim gray
    Unknown => "rgb(0,0,0)"
);                                    #black
